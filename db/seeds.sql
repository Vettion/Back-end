-- Inserts servicios
insert into service(name_service, price, duration_minutes, description) values
('Consulta General', 35.00, 30, 'Revisión rutinaria de salud'),
('Urgencias', 70.00, 60, 'Atención médica inmediata fuera de horario'),
('Vacunación Anual', 45.00, 45, 'Vacunas obligatorias anuales'),
('Vacuna Rabia', 25.00, 30, 'Inmunización específica contra la rabia'),
('Limpieza Dental', 120.00, 90, 'Limpieza por ultrasonidos y pulido'),
('Cirugía Menor', 150.00, 120, 'Procedimientos sencillos con anestesia local'),
('Cirugía Mayor', 450.00, 180, 'Procedimientos complejos con anestesia general'),
('Radiografía', 85.00, 60, 'Estudio radiológico completo'),
('Analítica de Sangre', 60.00, 45, 'Hemograma y bioquímica completa'),
('Peluquería y baño', 30.00, 30, 'Corte de pelo profesional y baño higíenico');
